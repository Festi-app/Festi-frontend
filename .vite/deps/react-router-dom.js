import {
  ...
  r as __toESM,
  t as require_react,
} from './react-CdAdxE6i.js'
import { t as require_react_dom } from './react-dom-C_Bf42TS.js'
//#region node_modules/.pnpm/react-router@7.15.0_react-dom@19.2.6_react@19.2.6__react@19.2.6/node_modules/react-router/dist/development/chunk-5KNZJZUH.mjs
...
function throwStaticHandlerAbortedError(request, isRouteRequest) {
  ...
  throw new Error(
    `${isRouteRequest ? 'queryRoute' : 'query'}() call aborted without an \`AbortSignal.reason\`: ${request.method} ${request.url}`
  )
}
        ...
        if (!pluginHandled) {
          ...
          if (isArray) {
            for (let i2 = 0; i2 < input.length; i2++)
              result +=
                (i2 ? ',' : '') + (i2 in input ? flattenValue(input[i2]) : HOLE)
            str[index] = `${result}]`
            ...
            str[index] =
              `["${TYPE_REGEXP}",${JSON.stringify(input.source)},${JSON.stringify(input.flags)}]`
...
//#endregion
//#region node_modules/.pnpm/react-router@7.15.0_react-dom@19.2.6_react@19.2.6__react@19.2.6/node_modules/react-router/dist/development/chunk-RMD3H4O3.mjs
/**
 * react-router v7.15.0
 *
 * Copyright (c) Remix Software Inc.
...
function derive(build, mode) {
  ...
  let requestHandler = async (request, initialContext) => {
    ...
    if (requestUrl.pathname === manifestUrl)
      try {
        return await handleManifestRequest(
          build,
...
//#endregion
//#region node_modules/.pnpm/react-router@7.15.0_react-dom@19.2.6_react@19.2.6__react@19.2.6/node_modules/react-router/dist/development/dom-export.mjs
/**
 * react-router v7.15.0
 *
 * Copyright (c) Remix Software Inc.
...
//#endregion
//#region node_modules/.pnpm/react-router-dom@7.15.0_react-dom@19.2.6_react@19.2.6__react@19.2.6/node_modules/react-router-dom/dist/index.mjs
/**
