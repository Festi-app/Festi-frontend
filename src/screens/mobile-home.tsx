  ...
  return (
    <div
      style={{
        ...
        bottom: 14,
        borderRadius: 28,
        background: dark ? 'rgba(19,38,45,0.92)' : 'rgba(255,255,255,0.92)',
        ...
        return (
          ...
          >
            <div style={{ width: 22, height: 22 }}>
              {it.icon(on ? SPOT_TOKENS.ink : t.ink60)}
            </div>
...
export function SpotStatusWash({
  color = '#A9E5E7',
  height = 58,
}: {
  color?: string
  ...
  return (
    ...
    >
      ...
      {more && (
        ...
        >
          전체{' '}
          <div style={{ width: 12, height: 12 }}>{I.chev(undefined, 'r')}</div>
        </div>
      )}
    </div>
  )
