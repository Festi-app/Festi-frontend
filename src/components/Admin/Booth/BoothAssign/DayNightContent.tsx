...
export function DayNightContent({
  ...
  return (
    <>
      {/* Active day selector (map interaction) */}
      ...
      <div className="flex-1 overflow-y-auto">
          ...
          {(() => {
            ...
            return (
              <>
                ...
                {slotOrgs.length === 0 ? (
                  <div className="py-1 text-center text-[11px] text-ink-40">
                    신청 부스 없음
                  </div>
                ) : (
                    ...
                    {slotOrgs.map((org) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            background:
                              assigned > 0 ? `${org.color}15` : undefined,
                          }}
                        >
                          <div
        ...
        {/* Permission list — filtered to selected day + current time */}
        <div className="p-4">
          {(() => {
